...
/**
 * Recursively generate hierarchy based on db data. This could be generated by db service.
 * Using for demo.
 * @param {*} employees
 * @param {*} teams
...
/**
 * Get organization tree for current id.
 * @param {*} currentMember
 * @param {*} employees
 * @param {*} teams
 * @returns organization tree for current id.
 */
...
/**
 * Filter the organization tree based on passed string, filter using name, email and phone.
 * @param {*} currentMember
 * @param {*} employees
 * @param {*} teams
 * @param {*} filterString
 * @returns Filtered organization hierarchy.
 */
...
export const getTruncateLength = (type) => {
  return type === ORG_MAIN ? 35 : type === TEAM_HEAD ? 30 : type === TEAM_LEADER ? 25 : 25;
};
